...
```{r fgsea_signature}
m_polarization <- list(M1_upregulated = dplyr::filter(DEG, log2FoldChange > 0, padj < 0.05) %>% pull(gene_name),
                       M2_upregulated = dplyr::filter(DEG, log2FoldChange < 0, padj < 0.05) %>% pull(gene_name))
